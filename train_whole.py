...
from model_whole import T5Reggressor
from utils import *
from dataset_whole import train_valid_test_split, custom_dataloader
...
def train(model, optimizer, scheduler, loss_function, 
    ...
    for epoch in range(epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            batch_inputs = batch['input_tensor']
            batch_masks = batch['mask_tensor']
            batch_labels = batch['label_tensor']
